...
const Header = ({ darkMode, setDarkMode }) => {
  return (
    <header className="bg-white z-20 dark:bg-gray-900 shadow-md py-4 px-[22rem] fixed">
      <div className="container flex items-center">
        <h1 className="text-2xl font-bold text-purple-500 dark:text-purple-500 whitespace-nowrap">Alan Parmar</h1>
